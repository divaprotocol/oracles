...
interface IDIVAGoplugin {
    ...
    // Struct for `getPoolIdsForRequesters` function input.
    struct ArgsGetPoolIdsForRequesters {
        address requester;
        uint256 startIndex;
        uint256 endIndex;
    }
    ...
    /**
     * @dev Returns the array of poolIds for which the provided requesters
     * are entitled to claim the fees/tip.
     * @param _argsGetPoolIdsForRequesters Struct array containing requester
    ...
    /**
     * @dev Returns the length of pool ids for the requesters.
     * @param _requesters Array of requester addresses.
     */
